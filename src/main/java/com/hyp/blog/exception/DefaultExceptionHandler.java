...
+---------------------------------------------------------------------------
*/
package com.hyp.blog.exception;

import com.alibaba.fastjson.JSON;

import com.hyp.blog.exception.returnresult.MyError;
import com.hyp.blog.exception.returnresult.MyResultVO;
...
public class DefaultExceptionHandler implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request,
        ...
        if (ex instanceof IllegalArgumentException || ex instanceof IllegalStateException || ex instanceof com.hyp.blog.exception.MyDefinitionException) {
